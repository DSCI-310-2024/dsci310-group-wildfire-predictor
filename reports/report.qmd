...
![Histogram of Fire Area](src/figures/histogram_fire_area.png)


![Barplot of Fires by Region](src/figures/barplot_fires_by_region.png)
...
![Correlation Matrix](src/figures/correlation_matrix.png)

![Predicted versus Actual](src/figures/predicted_vs_actual.png)

![Residual Plot](src/figures/residual_plot.png)

![Line Plot](src/figures/line_plot.png\)
...
Harris, C.R. (2020). Array programming with NumPy. Nature, 585, pp.357–362.
...
Pedregosa, F. (2011). Scikit-learn: Machine learning in Python. Journal of machine learning research, 12(Oct), pp.2825–2830.
...
Python Software Foundation (2022). zipfile -- Work with ZIP archives. Python 3 Documentation. https://docs.python.org/3/library/zipfile.html
